...
contract RegisterCubesPlatinum is Script {
    ...
    function registerInBatches(
        bytes32[] memory hashes,
        OneMillionCubes.CubeType cubeType
    ) internal {
        ...
        for (uint256 batchIndex = 0; batchIndex < numBatches; batchIndex++) {
            ...
            OneMillionCubes.CubeRegistration[]
                memory registrations = new OneMillionCubes.CubeRegistration[](
                    batchSize
                );
